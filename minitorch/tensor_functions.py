...
class Neg(Function):
    ...
    def forward(ctx: Context, t1: Tensor) -> Tensor:
        """Forward method for Neg"""
        return t1.f.neg_map(t1)

    @staticmethod
    def backward(ctx: Context, grad_output: Tensor) -> Tensor:
        """Backward Method for Neg"""
...
class Inv(Function):
    @staticmethod
    def forward(ctx: Context, t1: Tensor) -> Tensor:
        """Forward method for Inv"""
        ctx.save_for_backward(t1)
        return t1.f.inv_map(t1)

    @staticmethod
    def backward(ctx: Context, grad_output: Tensor) -> Tensor:
        """Backward method for Inv"""
        (t1,) = ctx.saved_values
...
def grad_central_difference(
    ...
    """Gradient central difference method"""
    x = vals[arg]
    up = zeros(x.shape)
    up[ind] = epsilon
